...
class OctavioClient:
    ...
    def __init__(
        ...
        *,
        ...
        self.midi_endpoint_url = '/piano'
        self.heartbeat_endpoint_url = '/heartbeat'
        self.midi_request_url = f'{self.server_url}{self.midi_endpoint_url}'
        self.heartbeat_request_url = f'{self.server_url}{self.heartbeat_endpoint_url}'
